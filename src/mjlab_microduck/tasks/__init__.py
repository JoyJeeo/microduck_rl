...
from .microduck_roller_accel_brake_env_cfg import (
...
register_mjlab_task(
    task_id="Mjlab-RollerAccelBrake-Flat-MicroDuck",
    env_cfg=make_microduck_roller_accel_brake_env_cfg(),
    play_env_cfg=make_microduck_roller_accel_brake_env_cfg(play=True),
    rl_cfg=MicroduckRollerAccelBrakeRlCfg,
    runner_cls=MicroduckOnPolicyRunner,
)
...
_BACKLASH_TASKS = (
    ...
    ("Mjlab-RollerAccelBrake-Flat-Backlash-MicroDuck", make_microduck_roller_accel_brake_env_cfg, {}, MicroduckRollerAccelBrakeRlCfg, _BL_ROLLERS),
